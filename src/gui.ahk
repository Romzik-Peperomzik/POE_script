...
Gui, Add, GroupBox, x32 y59 w420 h120 , Quick Flasks
...
Gui, Font, S9 CDefault Bold, Verdana
Gui, Add, GroupBox, x32 y199 w240 h160 , Auto Flasks
Gui, Font, norm, 
...
Gui, Font, S9 CDefault Bold, Verdana
Gui, Add, GroupBox, x32 y369 w240 h140 , Loot
...
Gui, Font, norm, 
Gui, Font, S9 CDefault Bold, Verdana
Gui, Add, GroupBox, x292 y199 w410 h310 +Buttons, Misc
Gui, Add, Text, x302 y229 w50 h20 , Alt + Z
Gui, Font, norm, 
Gui, Add, Text, x362 y229 w210 h20 , get [coordinate, color] on cursor
Gui, Add, Button, x942 y619 w100 h30 , Apply change
Gui, Font, S9 CDefault Bold, Verdana
Gui, Add, Text, x42 y219 w50 h20 , Ctrl + F
Gui, Add, Text, x492 y89 w160 h20 , Desecrate -> Cremation
Gui, Add, Text, x492 y119 w60 h20 , BF -> BB
Gui, Add, Text, x302 y269 w150 h20 , Auto Walk (lmb hold)
Gui, Add, Text, x302 y309 w130 h20 , Quick Game Logout
Gui, Add, Text, x302 y349 w100 h20 , Open Portal
Gui, Add, Text, x302 y389 w90 h20 , Go to Hideout
Gui, Add, Text, x302 y429 w220 h20 , Invite to Party by Last Message
Gui, Add, Text, x302 y469 w220 h20 , Kick from Party by Last Message
Gui, Add, GroupBox, x472 y59 w200 h120 , Abilities sequences
Gui, Add, GroupBox, x702 y59 w300 h90 , Auto Logout
Gui, Add, Text, x42 y479 w40 h20 , delay:
Gui, Add, Edit, x462 y269 w110 h20 , %life_color%
Gui, Add, Text, x492 y149 w170 h20 , Smoke Mine -> Detonate
Gui, Add, Edit, x462 y349 w110 h20 , %life_color%
Gui, Add, Edit, x462 y309 w110 h20 , %life_color%
Gui, Add, Edit, x462 y389 w110 h20 , %life_color%
Gui, Add, Edit, x522 y429 w110 h20 , %life_color%
Gui, Add, Edit, x522 y469 w110 h20 , %life_color%
Gui, Add, Button, x592 y269 w90 h20 , Button
