...
Gui, Add, Text, x42 y19 w430 h20 , Choose and checkbox hotkeys functions whichever u need.
Gui, Add, Text, x392 y19 w440 h20 , If u want to change hotkey, click to field and tap at key or combination keys.
Gui, Font, S9 CDefault Bold, Verdana
...
Gui, Add, Text, x622 y249 w230 h10 , Put Smoke and Detonate mine keys from
Gui, Add, Text, x622 y269 w230 h10 , game at form below. It should be same
...
Gui, Add, Text, x622 y669 w230 h10 , Put cast time value from in game tooltip here.
Gui, Font, norm, 
Gui, Font, S9 CDefault Bold, Verdana
...
Gui, Add, Edit, x162 y609 w70 h20 vlogout_life_color, %logout_life_color%
Gui, Font, S9 CDefault Bold, Verdana
Gui, Add, Text, x432 y539 w153 h20 , How to use autologout:
...
Gui, Add, Text, x312 y599 w275 h20 , where autologout trigger should been activated.
...
Gui, Show, x285 y119 h778 w908, New GUI Window
Return
